...
public class FachadaCadastros {
	...
	FachadaGenerics<Cliente> facCliente = new FachadaCliente();
	FachadaGenerics<Carro> facCarro = new FachadaCarro();
	FachadaGenerics<Motorista> facMotorista = new FachadaMotorista();
	FachadaGenerics<CartaoCredito> facCartao = new FachadaCartao();
	FachadaGenerics<Aluguel> facAluguel = new FachadaAluguel();
	FachadaGenerics<Grupo> facGrupo = new FachadaGrupo();
	FachadaGenerics<Reserva> facReserva = new FachadaReserva();
	...
	public Collection<CartaoCredito> consultarTodosCartoes() throws SQLException {
